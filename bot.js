...
setInterval(() => {
  http.get(`http://Pbot.glitch.me/`);
}, 280000);

const Discord = require('discord.js');  //WESO#0001
const client = new Discord.Client();
const client2 = new Discord.client2();  //WESO#0001
...
client.on('message', msg => {  //WESO#0001
  ...
  client.on('message', msg => {  //WESO#0001
    if (msg.content === '.') {  //WESO#0001
      msg.reply('** :heart: :grin: ولكم منور السيرفر لا تنسى تفاعل**');  //WESO#0001
    }
  });
 ...
 m.createRole({
  ...
  client.on("message", message => {  //WESO#0001
    if(message.content.startsWith(prefix + 'tempvoice')) {  //WESO#0001
...
『-tempvoice ====> لصنع روم صوتي مؤقت
『-inv ====> لدعوة البوت الى سيرفرك
『-credits ====>لمعرفة عدد الكريديتس الخاصه بك
『-daily ====>للحصول على  كريدتس مجانا
**
...
『-mroles ====> صنع رولات كامله بس لازم تدخل و تعدل لون و برميشون
**
`)
   message.author.sendEmbed(embed)
      message.reply('تم ارسالك بلخاص')
